Describe "AzureConfig" -Tag "Azure", "APRL", "Reliability", "Resiliency" {
    ...
    It "AZR.0001: Deploy Azure Firewall across multiple availability zones" -Tag "AZR.0001", "AzureFirewall", "Severity:High" {
    ...
    It "AZR.0002: Deploy Virtual Machines across availability zones" -Tag "AZR.0002", "Compute", "Severity:High" {
    ...
    It "AZR.0003: Ensure Standard Load Balancer is zone-redundant" -Tag "AZR.0003", "LoadBalancer", "Severity:High" {
    ...
    It "AZR.0004: Ensure Load Balancer backend pool contains at least two instances" -Tag "AZR.0004", "LoadBalancer", "Severity:High" {
    ...
    It "AZR.0005: Use Standard SKU and zone-redundant Public IP addresses" -Tag "AZR.0005", "PublicIP", "Severity:High" {
    ...
    It "AZR.0006: Ensure Application Gateway autoscale is enabled with minimum capacity >= 2" -Tag "AZR.0006", "ApplicationGateway", "Severity:Medium" {
    ...
    It "AZR.0007: Ensure storage accounts are zone or region redundant" -Tag "AZR.0007", "Storage", "Severity:High" {
    ...
    It "AZR.0008: Enable zone redundancy for Azure Cache for Redis" -Tag "AZR.0008", "Redis", "Severity:High" {
    ...
    It "AZR.0009: Ensure Event Hub namespace zone redundancy is enabled" -Tag "AZR.0009", "EventHub", "Severity:High" {
    ...
    It "AZR.0010: Key vaults should have soft delete enabled" -Tag "AZR.0010", "KeyVault", "Severity:High" {
    ...
    It "AZR.0011: Key vaults should have purge protection enabled" -Tag "AZR.0011", "KeyVault", "Severity:Medium" {
    ...
    It "AZR.0012: Deploy Application Gateway in a zone-redundant configuration" -Tag "AZR.0012", "ApplicationGateway", "Severity:High" {
    ...
    It "AZR.0013: Choose a zone-redundant VPN gateway SKU" -Tag "AZR.0013", "VPNGateway", "Severity:High" {
    ...
    It "AZR.0015: Enable Soft Delete for Recovery Services Vaults" -Tag "AZR.0015", "Backup", "Severity:Medium" {
    ...
    It "AZR.0016: Configure Cosmos DB accounts with at least two regions" -Tag "AZR.0016", "CosmosDB", "Severity:High" {
    ...
    It "AZR.0017: Enable service-managed failover for multi-region Cosmos DB accounts" -Tag "AZR.0017", "CosmosDB", "Severity:High" {
    ...
    It "AZR.0018: Deploy AKS cluster node pools across availability zones" -Tag "AZR.0018", "AKS", "Severity:High" {
    ...
    It "AZR.0019: Enable Active-Active mode for VPN Gateways" -Tag "AZR.0019", "VPNGateway", "Severity:Medium" {
    ...
    It "AZR.0020: Use Standard Load Balancer SKU" -Tag "AZR.0020", "LoadBalancer", "Severity:High" {
    ...
    It "AZR.0021: Migrate to Application Gateway v2" -Tag "AZR.0021", "ApplicationGateway", "Severity:High" {
    ...
    It "AZR.0022: Use Health Probes to detect Application Gateway backend availability" -Tag "AZR.0022", "ApplicationGateway", "Severity:High" {
    ...
    It "AZR.0023: Upgrade Basic SKU Public IP addresses to Standard SKU" -Tag "AZR.0023", "PublicIP", "Severity:Medium" {
    ...
    It "AZR.0024: Use Active Geo Replication for Azure SQL databases" -Tag "AZR.0024", "SQL", "Severity:High" {
    ...
    It "AZR.0025: Configure Auto Failover Groups for Azure SQL databases" -Tag "AZR.0025", "SQL", "Severity:High" {
    ...
    It "AZR.0026: Enable zone redundancy for Azure SQL Database" -Tag "AZR.0026", "SQL", "Severity:High" {
    ...
    It "AZR.0028: Migrate API Management services to Premium SKU to support Availability Zones" -Tag "AZR.0028", "APIM", "Severity:High" {
    ...
    It "AZR.0029: Enable Availability Zones on Premium API Management instances" -Tag "AZR.0029", "APIM", "Severity:High" {
    ...
    It "AZR.0030: Upgrade API Management platform version to stv2" -Tag "AZR.0030", "APIM", "Severity:High" {
    ...
    It "AZR.0032: Enable DDoS Protection for Virtual Networks" -Tag "AZR.0032", "VirtualNetwork", "Severity:High" {
    ...
    It "AZR.0035: Deploy App Service to a staging slot" -Tag "AZR.0035", "AppService", "Severity:Low" {
    ...
    It "AZR.0036: Migrate App Service Plan to availability zone support" -Tag "AZR.0036", "AppService", "Severity:High" {
    ...
    It "AZR.0037: Use Standard or Premium tier for App Service Plans" -Tag "AZR.0037", "AppService", "Severity:High" {
    ...
    It "AZR.0038: Set minimum instance count to 2 for App Service Plans" -Tag "AZR.0038", "AppService", "Severity:High" {
...
Describe "AzureConfig" -Tag "Azure", "APRL", "Security" {
    ...
    It "AZR.0027: Configure Service Bus minimum TLS version to 1.2 or higher" -Tag "AZR.0027", "ServiceBus", "Severity:High" {
    ...
    It "AZR.0031: Ensure all subnets have a Network Security Group associated" -Tag "AZR.0031", "VirtualNetwork", "Severity:Low" {
    ...
    It "AZR.0033: Use Private Endpoints instead of Service Endpoints for PaaS services" -Tag "AZR.0033", "VirtualNetwork", "Severity:Medium" {
...
Describe "AzureConfig" -Tag "Azure", "APRL", "OperationalExcellence" {
    ...
    It "AZR.0034: Enable Virtual Network Flow Logs" -Tag "AZR.0034", "VirtualNetwork", "Severity:Medium" {
